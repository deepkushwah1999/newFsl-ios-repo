...
class ODI_Matches extends Component {
  constructor(props) {
    super(props);
    this.state = {
                    ...
                    <ScrollView>
                      <>
                        {recentdata &&
                          ...
                          recentdata.data.filter((elementTemp) => (elementTemp.match_type === "ODI")).length > 0
                          ?
                          recentdata.data.filter((elementTemp) => (elementTemp.match_type === "ODI")).map((element, index) => (
                            <>
...
export default connect(mapStateToProps)(ODI_Matches);
