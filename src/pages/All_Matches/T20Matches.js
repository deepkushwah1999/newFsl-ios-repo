...
class T20Matches extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  render() {
    ...
    console.log("recent111111111133333333322222222222222",recentdata);
                  ...
                  <ScrollView>
                    <>
                      {recentdata &&
                        ...
                        recentdata.data.filter((elementTemp) => (elementTemp.match_type === "T20")).length > 0
                        ?
                        recentdata.data.filter((elementTemp) => (elementTemp.match_type === "T20")).map((element, index) => (
                          <>
                        ...
                        (
                          <>
                            ...
                            <Text style={{ color: 'darkred', textAlign: 'center', fontSize: 18 }}>No Match away</Text>
                          </>
...
export default connect(mapStateToProps)(T20Matches);
