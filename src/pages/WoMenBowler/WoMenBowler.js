      ...
      <>
        ...
        <View style={{ flexDirection: 'row', backgroundColor: theme&&theme.primary?theme.primary:null, }}>
          <View style={{ margin: 15, flexDirection: 'row', marginTop: 10,  }}>
            ...
            <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'white', marginLeft: 100, alignSelf: 'center' }}>{leng.theme=="en"?"Bowler":"बॉलर "}</Text>
          </View>
        </View>
                ...
                <View style={{ width: '100%', alignSelf: 'center', margin: 10 }}>
                  ...
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between', padding: 10, backgroundColor: 'lightgray' }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: "35%" }}>
                      <Text style={{ color: 'black',fontWeight:'bold',fontSize:15, marginRight: 20,textDecorationLine:'underline' }}>{leng.theme=="en"?"Rank":"रैंक "}</Text>
                      <Text style={{ color: 'black',fontWeight:'bold',fontSize:15, marginRight: 20,textDecorationLine:'underline' }}>{leng.theme=="en"?"Player":"प्लेयर "}</Text>
                    </View>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center' }}>
                      <Text style={{ color: 'black',fontWeight:'bold',fontSize:15, marginLeft: 15,textDecorationLine:'underline' }}>{leng.theme=="en"?"Rating":"रेटिंग"}</Text>
                    </View>
                  </View>
