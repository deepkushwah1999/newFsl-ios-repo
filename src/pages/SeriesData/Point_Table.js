...
class Point_Table extends Component {
  constructor(props) {
    super(props);
    this.state = {
      sportName: 'CRICKET',
              ...
              {this.state.matchType == 'T20' ? (
                <ScrollView>
                  {pointsTableData && pointsTableData.length > 0 ? (
                    <>
                      <ScrollView>
                        <View
                          ...
                          {pointsTableData && pointsTableData.length > 0 ? (
                            pointsTableData.map((element, index) => (
                              <>
                                <View
                                  style={{
                                    flexDirection: 'row',
                    ...
                    <>
                      <Image source={require('../../images/error1a.png')} style={{ height: 180, width: 180, resizeMode: 'stretch', alignSelf: 'center', marginTop: 35 }} />
                      <Text
                        style={{
                          fontSize: 20,
                          color: theme && theme.primary ? theme.primary : null,
                          alignSelf: 'center',
                          margin: 20,
                          fontWeight: 'bold'
                        }}>
                        Score Not Recored Found.
                      </Text>
...
export default connect(mapStateToProps)(Point_Table);
