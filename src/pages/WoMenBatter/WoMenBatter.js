          ...
          <>
            ...
            <View style={{ flexDirection: 'row', backgroundColor: theme && theme.primary ? theme.primary : null, }}>
              <View style={{ margin: 15, flexDirection: 'row', marginTop: 10, }}>
                ...
                <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'white', marginLeft: 100, alignSelf: 'center' }}>{leng.theme == "en" ? "Batter" : "बैटर "}</Text>
              </View>
            </View>
...
export default connect(mapStateToProps)(Batter);