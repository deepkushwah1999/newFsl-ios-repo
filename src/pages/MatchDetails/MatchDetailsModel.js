...
const { width, height } = Dimensions.get('window');
  ...
  const [routes] = React.useState([
    { key: 'first', title:  leng.theme=="en"?"Info":"इन्फ़ो " },
    { key: 'second', title: leng.theme=="en"?"Playing XI":"प्लेईंग XI " },
  ...
  const [routesLive] = React.useState([
    ...
    { key: 'second', title:  leng.theme=="en"?"Info":"इन्फ़ो " },
  ...
  const [routesFinished] = React.useState([
    ...
    { key: 'second', title: leng.theme=="en"?"Info":"इन्फ़ो " },
    { key: 'third', title: leng.theme=="en"?"Playing XI":"प्लेईंग XI " },
  ]);
  ...
  function MatchDetailsModel(props)  {
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 15 }}>
          ...
          <View style={{ marginTop: 20, alignSelf: 'center', flexDirection: 'row' }}>
            ...
            // fontFamily: 'Poppins-Medium'
              ...
              {props.route.params.team_a_short + " VS11 " + props.route.params.team_b_short}
                    ...
                    <FlatList
                      ...
                      renderItem={({ item }) => (
                        ...
                        <ScrollView>
                          ...
                          <TouchableOpacity style={{}}   onPress={() =>props.
                        navigation.navigate('MatchDetails',setShow(false), {
        ...
        <ScrollView contentContainerStyle={{ flexGrow: 1 }} scrollEnabled={false}>
          <View style={{ flex: 1, backgroundColor: theme&&theme.primary?theme.primary:null }}>
            ...
            <View style={{ height: height - 50 }}>
              ...
              {
                props.route.params.sportStatus === 'Finished' ?
                  <TabView
                    indicatorStyle={{ backgroundColor: 'white' }}
                    style={{ backgroundColor: 'white' }}
...
export default connect(mapStateToProps)(MatchDetailsModel)
