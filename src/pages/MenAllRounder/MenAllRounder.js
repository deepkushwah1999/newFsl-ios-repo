...
const DATA = [
  {
    ...
    seriesName: 'The Ashes 2021-2022',
    stadium: '2nd Test Adeleda Oval,  Australia',
    innig1: 'Wellington',
    innig2: 'Otega',
    live: 'Start At 03:30 AM',
    result: "Favourite",
    prs: 'PRS',
    nu1: '00',
    nu2: "01"
...
class MenAllRounder extends Component {
  constructor(props) {
    super(props)
    this.state = {
      data: DATA,
      ...
      <>
        ...
        <View style={{ flexDirection: 'row', backgroundColor:theme&&theme.primary?theme.primary:null, }}>
          <View style={{ margin: 15, flexDirection: 'row', marginTop: 10, }}>
            ...
            <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'white', marginLeft: 100, paddingTop: 3 }}>{leng.theme=="en"?"AllRounder":"ऑलरॉउंडर "}</Text>
          </View>
        </View>
                ...
                <View style={{ width: '100%', alignSelf: 'center', margin: 15 }}>
                  ...
                  <View style={{ flexDirection: 'row', justifyContent: 'space-between', padding: 10, backgroundColor: 'lightgray', paddingVertical: 20 }}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignSelf: 'center' }}>
                      <Text style={{ color: 'black', marginRight: 15, fontSize: 15, fontWeight: 'bold',textDecorationLine:'underline' }}>{leng.theme=="en"?"Rating":"रेटिंग"},leng</Text>
                    </View>
                  </View>
                    ...
                    getRankData && getRankData.length > 0 ?
                      ...
                      getRankData.map((element, index) => (
                        <>
                          ...
                          <TouchableOpacity style={{ backgroundColor: index % 2 ? theme&&theme.secondary?theme.secondary:null : theme&&theme.thirdback?theme.thirdback:null, flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 20, paddingHorizontal: 10, alignItems: 'center' }}>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: "35%" }}>
...
export default connect(mapStateToProps)(MenAllRounder);